...
%			font=\footnotesize,
		...
		\matrix[row sep=-2mm,column sep=12mm] { %
			...
			& & & & \node (I-I) [treatment,highlighttx] {behavioral intervention + \\ medical management + \\ placebo}; & \node (sbgp7) [subgroup,highlightsub] {G}; \\
...
%		\draw[dashed,lightgray] (time2.north west) --++(90:33cm);
		...
		\draw[trialarrow,highlightline] (R5-I.east) -- (I-I.west);
