...
%			font=\footnotesize,
		...
		\matrix[row sep=-2mm,column sep=12mm] { %
			...
			& & & & \node (H-I) [treatment,highlighttx] {naltrexone + \\ telehealth}; & \node (sbgp6) [subgroup,highlightsub] {F}; \\
			& \node (B-I) [treatment,highlighttx] {naltrexone + \\ medical management + \\ lenient non-response}; & & & & \\[-6mm]
			& & & & \node (I-I) [treatment] {behavioral intervention + \\ medical management + \\ placebo}; & \node (sbgp7) [subgroup] {G}; \\
			& & \node (b4-I) [blank] {}; & \node (R5-I) [randomize, rerand] {R}; & & \\
			& & & & \node (J-I) [treatment,highlighttx] {behavioral intervention + \\ medical management + \\ naltrexone}; & \node (sbgp8) [subgroup,highlightsub] {H};\\
		};
...
%		\draw[dashed,lightgray] (time2.north west) --++(90:33cm);
		...
		\draw[highlightline] (B-I.east) -- (b3-I.center);
		\draw[highlightline] (B-I.east) -- (b4-I.center);
		\draw[trialarrow,highlightline] (b3-I.center) -- node[rlabel] {Responders} (R4-I.west);
		\draw[trialarrow,highlightline] (b4-I.center) -- node[nrlabel] {Non-Responders} (R5-I.west);
		\draw[trialarrow] (R4-I.east) -- (G-I.west);
		\draw[trialarrow,highlightline] (R4-I.east) -- (H-I.west);
		\draw[trialarrow] (R5-I.east) -- (I-I.west);
		\draw[trialarrow,highlightline] (R5-I.east) -- (J-I.west);
