...
%			font=\footnotesize,
		...
		\matrix[row sep=-2mm,column sep=12mm] { %
			...
			& & & & \node (C-I) [treatment, highlighttx] {naltrexone}; & \node (sbgp1) [subgroup, highlightsub] {A}; \\
			...
			& & & & \node (G-I) [treatment,highlighttx2] {naltrexone}; & \node (sbgp5) [subgroup,highlightsub2] {E}; \\
			& & \node (b3-I) [blank] {}; & \node (R4-I) [randomize, rerand] {R}; & & \\
			& & & & \node (H-I) [treatment,highlighttx2] {naltrexone + \\ telehealth}; & \node (sbgp6) [subgroup,highlightsub2] {F}; \\
			& \node (B-I) [treatment,highlighttx2] {naltrexone + \\ medical management + \\ lenient non-response}; & & & & \\[-6mm]
			& & & & \node (I-I) [treatment,highlighttx2] {behavioral intervention + \\ medical management + \\ placebo}; & \node (sbgp7) [subgroup,highlightsub2] {G}; \\
			& & \node (b4-I) [blank] {}; & \node (R5-I) [randomize, rerand] {R}; & & \\
			& & & & \node (J-I) [treatment,highlighttx2] {behavioral intervention + \\ medical management + \\ naltrexone}; & \node (sbgp8) [subgroup,highlightsub2] {H};\\
		};
...
%		\draw[dashed,lightgray] (time2.north west) --++(90:33cm);
		...
		\draw[trialarrow,highlightline] (R2-I.east) -- (C-I.west);
		...
		\draw[highlightline2] (B-I.east) -- (b3-I.center);
		\draw[highlightline2] (B-I.east) -- (b4-I.center);
		\draw[trialarrow,highlightline2] (b3-I.center) -- node[rlabel] {Responders} (R4-I.west);
		\draw[trialarrow,highlightline2] (b4-I.center) -- node[nrlabel] {Non-Responders} (R5-I.west);
		\draw[trialarrow,highlightline2] (R4-I.east) -- (G-I.west);
		\draw[trialarrow,highlightline2] (R4-I.east) -- (H-I.west);
		\draw[trialarrow,highlightline2] (R5-I.east) -- (I-I.west);
		\draw[trialarrow,highlightline2] (R5-I.east) -- (J-I.west);
