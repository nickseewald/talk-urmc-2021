...
%			\node [align=center,anchor=west] {\large \textbf{Stage 1}}; & &  \node [align=center,xshift=5mm] {\large \textbf{Stage 2}};\\[5mm]
			...
			& \node (blank1) [blank] {}; & & \node (stg2R) [treatment,stg2tx] {\footnotesize{naltrexone} \\ \textsc{\textbf{(step down)}}}; \\
			\node (stg1) [treatment] {naltrexone + \\medical management}; & & \\
			& \node (blank2) [blank] {}; & & \node (stg2NR) [treatment,stg2tx] {\footnotesize{behavioral intervention +} \\ \footnotesize{medical management +} \\ \footnotesize{naltrexone} \\ \textsc{\textbf{(augment)}}}; \\
		};
